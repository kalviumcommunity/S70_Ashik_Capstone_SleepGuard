...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070d1e] flex items-center justify-center relative overflow-hidden text-slate-100 font-sans py-12">
      <div className="absolute top-[10%] right-[-5%] w-[35vw] h-[35vw] bg-blue-600/20 rounded-full blur-[100px] floating-blob"></div>
      <div className="absolute bottom-[5%] left-[-10%] w-[45vw] h-[45vw] bg-indigo-600/20 rounded-full blur-[100px] floating-blob" style={{ animationDelay: '3s' }}></div>
